...
public class BookApp2 {
	...
	public static void main(String[] args) {
		...
		// 참조변수가 더 이상 객체를 참조하지 못하게 하기
		// 참조변수에 null값을 대입하면 해당 참조변수는 객체의 주소값대신 null을 가지게 된다.
		// null값이 저장된 참조변수는 더 이상 객체를 참조할 수 없다.
		// book1은 Book객체와의 연결이 끊어졌다.
		// *참조변수의 주소값이 null인 경우는 객체와의 연결이 끊어졌거나 혹은 아직 객체가 연결되지 않은 참조변수다.
//		book1 = null;
